...
function page() {
  ...
  async function GetBook() {
    const res = await axios.get("http://localhost:3000/books?ageGroup=جوان&genre=وحشت");
  ...
  return (
    <Box>
      ...
      {/* Description */}
      <Box sx={{ px:2}}>
        <Typography sx={{fontSize:"36px" ,color:"blue" , textAlign:"center", py:6}}>کتاب داستان وحشت جوان انتشارات ویدا</Typography>
