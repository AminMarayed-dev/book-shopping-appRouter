...
function Teenager() {
  ...
  async function GetBook() {
    const res = await axios.get("http://localhost:3000/books?ageGroup=نوجوان");
  ...
  return (
    <Box>
      <Box sx={{ display: "flex" , gap:1 , mt:2 , mx:2}}>
        ...
        <Typography sx={{ fontSize: "13.3px", textWrap: "nowrap" , fontWeight:"bold" }} onClick={()=>location.href="/product-category/teenager"}>
          {" "}
          رده سنی نوجوان
        </Typography>
...
<Typography sx={{m:"auto", textAlign:"center" , fontWeight:"bold" , mt:4 , mb:2}}>کتاب های جوان انتشارات ویدا</Typography>

      <Box sx={{ display: "flex", justifyContent: "space-between" , gap:3 , m:3 , }}>
        <Card sx={{boxShadow:4}} onClick={()=>location.href="/product-category/teenager/teenager-horror"}>
          <CardContent>
            <CardMedia
              component="img"
              height="80px" 
        ...
        <Card sx={{boxShadow:4}} onClick={()=>location.href="/product-category/teenager/teenager-fantasy"}>
          <CardContent>
            {" "}
            <CardMedia
              component="img"
